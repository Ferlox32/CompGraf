...
//LOWER BODY
/**  @type {Matrix4} */
var thighMatrix = new Matrix4().setTranslate(3, -7, 0);
/**  @type {Matrix4} */
var shinMatrix = new Matrix4().setTranslate(0, -7, 0);
/**  @type {Matrix4} */
var footMatrix = new Matrix4().setTranslate(0, -5, 1);
/**  @type {Matrix4} */
var RthighMatrix = new Matrix4().setTranslate(-3, -7, 0);
/**  @type {Matrix4} */
var RshinMatrix = new Matrix4().setTranslate(0, -7, 0);
/**  @type {Matrix4} */
var RfootMatrix = new Matrix4().setTranslate(0, -5, 1);
...
//LOWER BODY
var thighMatrixLocal = new Matrix4().setScale(4, 8, 4);
var shinMatrixLocal = new Matrix4().setScale(3, 9, 3);
var footMatrixLocal = new Matrix4().setScale(3, 1, 5);
var RthighMatrixLocal = new Matrix4().setScale(4, 8, 4);
var RshinMatrixLocal = new Matrix4().setScale(3, 9, 3);
var RfootMatrixLocal = new Matrix4().setScale(3, 1, 5);
  ...
  switch (ch) {
    ...
    case "d":
      ...
      var currentArm = new Matrix4()
        ...
        .translate(0, -2.5, -1.0);
      RarmMatrix.setTranslate(0, -5, 0).multiply(currentArm);
      break;
    case "D":
      RarmAngle -= 15;
      var currentArm = new Matrix4()
	...
	case "y":
      ...
      var currentThighRot = new Matrix4()
        ...
        .translate(0, -2, 0);
      thighMatrix.setTranslate(3, -7, 0).multiply(currentThighRot);
      break;
    case "Y":
      thighAngle -= 15;
      var currentThighRot = new Matrix4()
	...
	case "i":
      ...
      var currentThighRot = new Matrix4()
        .setTranslate(0, 2, 0)
        .rotate(-RthighAngle, 1, 0, 0)
        .translate(0, -2, 0);
      RthighMatrix.setTranslate(-3, -7, 0).multiply(currentThighRot);
      break;
    case "I":
      RthighAngle -= 15;
      var currentThighRot = new Matrix4()
    ...
    case "k":
      RshinAngle += 15;
      var RcurrentShin = new Matrix4()
        .setTranslate(0, 2.5, 1.0)
        .rotate(-RshinAngle, 1, 0, 0)
        .translate(0, -2.5, -1.0);
      RshinMatrix.setTranslate(0, -7, 0).multiply(RcurrentShin);
      break;
    case "K":
      RshinAngle -= 15;
      var currentShin = new Matrix4()
        ...
        .rotate(-RshinAngle, 1, 0, 0)
        .translate(0, -2.5, -1.0);
      RshinMatrix.setTranslate(0, -7, 0).multiply(currentShin);
      break;
	default:
	  break;
  }
...
function draw() {
  ...
  // Rthigh relative to torso
  s.push(new Matrix4(s.top()).multiply(RthighMatrix));
  renderCube(s, RthighMatrixLocal);
  
  // Rshin relative to shoulder
  s.push(new Matrix4(s.top()).multiply(RshinMatrix));
  renderCube(s, RshinMatrixLocal);
  
  // Rfoot relative to arm
  s.push(new Matrix4(s.top()).multiply(RfootMatrix));
  renderCube(s, RfootMatrixLocal);
  s.pop();
  s.pop();
